                        ...
                        <el-row :gutter="4">
                            ...
                            <el-col :span="14">
                                <div class="d-flex flex-column">
                                    <strong class="mb-1" @click="handleGoToHotPost(post.companyId, post.id)">{{
                                        post.title }}</strong>
        ...
        methods: {
            ...
            getPostDetail() {
                getPostDetail(this.postId).then((response) => {
                    ...
                    console.log(this.postDetail.image);
                    console.log(this.postDetail.createTime);
            ...
            likePost(id) {
                likePost(id).then((response) => {
                    ...
                    console.log(this.postDetail.likes);
