      ...
      <b-row>
        <b-media class="resume-wrapper">
          <div class="resume-body">
            <div
              class="required"
              v-if="
                this.resumeDetail.name == null ||
                this.resumeDetail.email == null ||
                this.resumeDetail.birth == null ||
                this.resumeDetail.gender == null ||
                !this.resumeDetail.userExpectJob.expectCity ||
                !this.resumeDetail.userExpectJob.expectPosition ||
                !this.resumeDetail.userExpectJob.expectWorkType ||
            ...
            >
              ...
              <div class="resume-updateTime" style="margin-left: 210px">
                更新时间：{{ this.resumeDetail.updateTime }}
              </div>
              ...
              <div
                style="margin-right: 0px; margin-top: -4px; padding-left: 6px"
              >
                ...
                <div class="resume-box-edit">
                  ...
                  >
                    ...
                    >
                      ...
                      <el-button class="btn2" @click="showBasicDialog = false"
                        >取消</el-button
                      >
                    </div>
                  </el-form>
                    ...
                    <div class="info-other-row-l">
                      <div style="height: 34px">
                        <el-row
                          ...
                          style="width: 300px"
                          v-if="
                            this.resumeDetail.name &&
                            this.resumeDetail.name != ''
                          "
                          >{{ this.resumeDetail.name }}</el-row
                        >
                      </div>
                      ...
                      <el-row class="info-other"
                        >年龄：{{ this.resumeDetail.age }} 岁</el-row
                      >
                      <el-row class="info-other"
                        >邮箱：{{ this.resumeDetail.email }}</el-row
                      >
                      <el-row class="info-other"
                        >手机：{{ this.resumeDetail.phone }}</el-row
                      >
                    </div>
                    <div class="info-other-row-m">
                      <el-row class="info-other"
                        >政治面貌：
                        <span v-if="this.resumeDetail.maritalStatus == 0"
                          >中共党员（含预备党员）</span
                        >
                        <span v-if="this.resumeDetail.maritalStatus == 1"
                          >民主党派</span
                        >
                        <span v-if="this.resumeDetail.maritalStatus == 2"
                          >无党派人士</span
                        >
                        <span v-if="this.resumeDetail.maritalStatus == 3"
                          >团员</span
                        >
                        <span v-if="this.resumeDetail.maritalStatus == 4"
                          >群众</span
                        >
                      </el-row>
                      <el-row class="info-other"
                        >现居城市：{{ this.resumeDetail.curPlace }}</el-row
                      >
                      <el-row class="info-other"
                        >入职时间：{{ this.resumeDetail.returnTime }}</el-row
                      >
                    </div>
                  </div>
                </div>
                ...
                <el-row style="padding-left: 15px">
                  <div class="resume-eduinfo">
                    <div style="display: inline-block">
                      <div
                        class="resume-edu"
                        v-for="resumeEdu in this.resumeDetail.resumeEduList"
                        :key="resumeEdu.id"
                      >
                        <div class="edu-box-l" style="width: 330px">
                          ...
                          <el-row
                            class="info-other"
                            v-if="resumeEdu.degree && resumeEdu.degree != ''"
                    ...
                    <div class="resume-edu">
                      <div class="edu-box-l1">
                        ...
                        <el-row class="info-other"
                          ...
                          <span
                            v-if="
                              this.resumeDetail.userExpectJob.salaryId &&
                              this.resumeDetail.userExpectJob.salaryId != ''
                            "
                          >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 1
                              "
                              >5K-8K</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 2
                              "
                              >8K-10K</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 3
                              "
                              >10K-15K</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 4
                              "
                              >15K-20K</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 5
                              "
                              >20K-30K</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 6
                              "
                              >30K-50K</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 7
                              "
                              >50K以上</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 8
                              "
                              >5K以下</span
                            >
                            <span
                              v-if="
                                this.resumeDetail.userExpectJob.salaryId == 9
                              "
                              >面议</span
                            >
                          </span>
                      ...
                      <div class="edu-box-m1">
                        <el-row class="info-other"
                          ...
                          <span
                            v-if="
                              this.resumeDetail.userExpectJob.industry &&
                              this.resumeDetail.userExpectJob.industry != ''
                            "
                          >
                            {{ this.resumeDetail.userExpectJob.industry }}
                ...
                <div class="resume-box-edit">
                  <div style="padding-top: 20px">
                    ...
                    >
                      ...
                      <div
                        style="display: flex; height: 30px; padding-left: 10px"
                      >
                        <div>
                          <el-form-item
                            label="工作类型："
            ...
            <div class="resume-box" id="Resume-Experience">
              <div v-if="showExpDialog == false">
                ...
                <div
                  v-for="resumeExp in this.resumeDetail.resumeExpList"
                  :key="resumeExp.id"
                >
                  <div
                    style="
              ...
              <div v-if="showPracticeDialog == false">
                ...
                <el-row>
                  <div style="display: inline-block; padding-left: 15px">
                    <div
                      class="resume-info"
                      v-for="practice in this.resumeDetail.resumePracticeList"
                      :key="practice.id"
                    >
              ...
              <div v-if="showLanguageDialog == false">
                ...
                <div style="display: inline-block; padding-left: 15px">
                  <el-row
                    ...
                    v-for="(language, index) in this.resumeDetail
                      .resumeLanguageList"
                    :key="language.id"
                  >
                    <div class="resume-edu">
            ...
            <div class="resume-box" id="Resume-Awards">
              <div v-if="showAwardsDialog == false">
                ...
                <div style="display: inline-block; padding-left: 15px">
                  <el-row
                    style="display: inline-flex"
                    v-for="(awards, index) in this.resumeDetail
                ...
                <el-row>
                  ...
                  >
                    ...
                    <span
                      ...
                      "
                      >{{ this.resumeDetail.resumeSkillList.length }}/6</span
                    >
                ...
                <div class="resume-box-edit">
                  ...
                  <div style="padding-top: 20px">
                    ...
                    >
                      ...
                      <el-button class="btn2" @click="showSkillDialog = false"
                        >取消
                      </el-button>
                    </div>
                  </div>
                ...
                <div class="resume-box-edit">
                  ...
                  <div style="padding-top: 20px">
                    ...
                    >
                      ...
                      <el-button class="btn2" @click="showIntroDialog = false"
                        >取消
                      </el-button>
                    </div>
                  </div>
        ...
        <b-col class="right-box">
          ...
          <div class="resume-attachment resume-right-box1">
              ...
              <div style="width: 210px">
                <el-row
                  v-if="
                    ...
                    this.resumeDetail.attachResume.length > 0
                  "
                  style="
                    font-size: 14px;
            ...
            <el-form ref="resumeForm2" :model="resumeForm2" label-width="80px">
              <el-upload
                class="mt-2 upload-attach-box"
                :limit="1"
                :action="uploadAttachmentOptions.action"
            ...
            <el-row style="display: inline-flex">
              <div style="width: 210px">
                <div v-if="showEditAttachOther == false">
                  <el-row
                    v-for="(others, index) in this.resumeDetail
                      .resumeMergeAttachList"
                    :key="others.id"
                  >
                    <div style="display: inline-flex">
                      <div
          ...
          <div class="resume-preview resume-right-box1">
            ...
            <span class="right-num"
              >{{ this.resumeDetail.resumeCompleteProgress }}%</span
            >
            <el-progress
              class="pro-ress"
              :stroke-width="22"
              ...
              :status="
                this.resumeDetail.resumeCompleteProgress == 100
                  ? 'success'
                  : 'warning'
              "
            ></el-progress>
...
export default {
  ...
  methods: {
    ...
    handleUploadAttachOthersSuccess() {
      ...
      if (
        this.resumeDetail.resumeMergeAttachList &&
        this.resumeDetail.resumeMergeAttachList.length > 0
      ) {
    ...
    handleEditAttachOthers(index) {
      ...
      console.log(index);
      this.resumeAttachForm1.name = this.resumeDetail.resumeMergeAttachList[
        index
      ].name;
      this.resumeAttachForm1.link = this.resumeDetail.resumeMergeAttachList[
        index
      ].resumeAttach;
    ...
    requiredEdit() {
      if (
        ...
        this.resumeDetail.birth == "" ||
        !this.resume[index].birth ||
        this.resumeDetail.gender == "" ||
        !this.resume[index].gender ||
        this.resumeDetail.email == "" ||
        !this.resume[index].email
      ) {
        this.handleEditResumeBasic();
      } else if (
        this.resumeDetail.priority == "" ||
        !this.resumeDetail.priority
      ) {
