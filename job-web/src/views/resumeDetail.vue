            ...
            <b-row>
                <b-media class="resume-wrapper">
                    <div class="resume-body">
                        <div class="required" v-if="this.resumeDetail.name==null||this.resumeDetail.email==null||this.resumeDetail.birth==null||this.resumeDetail.gender==null||
                                        !this.resumeDetail.userExpectJob.expectCity||!this.resumeDetail.userExpectJob.expectPosition||!this.resumeDetail.userExpectJob.expectWorkType
                                        ||!this.resumeDetail.resumeEduList">
                        ...
                        <el-row class="rowbasic" style="display: inline-flex;height:70px;padding: 3px;position: relative;">
                            <div style="display: inline-flex;position: absolute;" class="titleText">
                                ...
                                <div style="padding-top: 6px;" v-if="showEditTitle==false">
                                    <span>{{this.resumeDetail.title}}</span>
                            ...
                            <div class="resume-updateTime" style="margin-left: 210px;">更新时间：{{this.resumeDetail.updateTime}}</div>
                            ...
                            <div style="margin-right: 0px;margin-top: -4px;padding-left: 6px;">
                                <div style="display: flex">
                                    <div>
                                        ...
                                        ></svg-icon>
                                        <span class="resume-updateTime" style="padding-left: 8px;padding-right: 9px">优先级
                            ...
                            <div v-if="showBasicDialog==false">
                                ...
                                <div class="resume-basicinfo row mt-3">
                                    <el-form class="avatorHolder" ref="resumeForm3" :model="resumeForm3">
                                        ...
                                        <upload-img :src="this.resumeDetail.avatar" @upload="onUpload"/>
                                    </el-form>
                                    <div class="resume-info">
                                        <div class="info-other-row-l">
                                            <div style="height: 34px">
                                                <el-row class="info-name" style="width: 300px" v-if="this.resumeDetail.name && this.resumeDetail.name!=''">{{this.resumeDetail.name}}</el-row>
                                            </div>
                                            <el-row class="info-other">性别：
                                                <span v-if="this.resumeDetail.gender==1">男</span>
                                                <span v-if="this.resumeDetail.gender==2">女</span>
                                            </el-row>
                                            <el-row class="info-other">年龄：{{this.resumeDetail.age}} 岁</el-row>
                                            <el-row class="info-other">邮箱：{{this.resumeDetail.email}}</el-row>
                                            <el-row class="info-other">手机：{{this.resumeDetail.phone}}</el-row>
                                        </div>
                                        <div class="info-other-row-m">
                                            <el-row class="info-other">政治面貌：
                                                <span v-if="this.resumeDetail.maritalStatus==0">中共党员（含预备党员）</span>
                                                <span v-if="this.resumeDetail.maritalStatus==1">民主党派</span>
                                                <span v-if="this.resumeDetail.maritalStatus==2">无党派人士</span>
                                                <span v-if="this.resumeDetail.maritalStatus==3">团员</span>
                                                <span v-if="this.resumeDetail.maritalStatus==4">群众</span>

                                            </el-row>
                                            <el-row class="info-other">现居城市：{{this.resumeDetail.curPlace}}</el-row>
                                            <el-row class="info-other">入职时间：{{this.resumeDetail.returnTime}}</el-row>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <el-row style="padding-left: 15px">
                                    <div class="resume-eduinfo">
                                        <div style="display: inline-block">
                                            <div class="resume-edu" v-for="resumeEdu in this.resumeDetail.resumeEduList"
                                                 :key="resumeEdu.id">
                                        ...
                                        <div class="resume-edu">
                                            <div class="edu-box-l1">
                                                <el-row class="edu-school" style="height: 24px" >
                                                    {{this.resumeDetail.userExpectJob.expectPosition}}
                                                </el-row>
                                                <el-row class="info-other">预期薪资：
                                                    <span v-if="this.resumeDetail.userExpectJob.salaryId && this.resumeDetail.userExpectJob.salaryId!=''">
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==1">5K-8K</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==2">8K-10K</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==3">10K-15K</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==4">15K-20K</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==5">20K-30K</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==6">30K-50K</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==7">50K以上</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==8">5K以下</span>
                                                                        <span v-if="this.resumeDetail.userExpectJob.salaryId==9">面议</span>
                                                                    </span>
                                                </el-row>
                                                <el-row class="info-other">工作类型：{{this.resumeDetail.userExpectJob.expectWorkType}}
                                                </el-row>
                                            </div>
                                            <div class="edu-box-m1">
                                                <el-row class="info-other">期望行业：
                                                    <span v-if="this.resumeDetail.userExpectJob.industry&&this.resumeDetail.userExpectJob.industry!=''"
                                                    > {{ this.resumeDetail.userExpectJob.industry }} </span>
                                                </el-row>
                                                <el-row class="info-other">工作城市：
                                                    <span> {{this.resumeDetail.userExpectJob.expectCity}} </span>
                                                </el-row>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="resume-box" id="Resume-Experience">
                            <div v-if="showExpDialog==false">
                                ...
                                <div v-for="resumeExp in this.resumeDetail.resumeExpList"
                                     :key="resumeExp.id">
                            ...
                            <div v-if="showPracticeDialog==false">
                                ...
                                <el-row>
                                    <div style="display: inline-block;padding-left: 15px;" >
                                        <div class="resume-info" v-for="practice in this.resumeDetail.resumePracticeList"
                                             :key="practice.id">
                            ...
                            <div v-if="showLanguageDialog==false">
                                ...
                                <div style="display: inline-block;padding-left: 15px">
                                    <el-row style="display: inline-flex"
                                            v-for="(language,index) in this.resumeDetail.resumeLanguageList"
                                            :key="language.id">
                                        <div class="resume-edu">
                                            <el-row style="width: 600px;display: inline-flex">
                                                <div style="width: 386px">
                                                    <span class="info-other">语种{{index+1}}：</span>
                                                    <span class="info-data">{{language.title}}</span>
                                                </div>
                                                <div style="width: 200px">
                                                    <span class="info-other">证书或分数：</span>
                                                    <span class="info-data">{{language.description}}</span>
                                                </div>
                                            </el-row>
                                        </div>
                                        <div class="resume-editbox">
                        ...
                        <div class="resume-box" id="Resume-Awards">
                            <div v-if="showAwardsDialog==false">
                                ...
                                <div style="display: inline-block;padding-left: 15px">
                                    <el-row style="display: inline-flex"
                                            v-for="(awards,index) in this.resumeDetail.resumeCertificateList"
                                            :key="awards.id">
                                        <div class="resume-edu">
                                            <el-row style="width: 600px;display: inline-flex">
                                                <div style="width: 386px">
                            ...
                            <div v-if="showSkillDialog==false">
                                <el-row>
                                    <div style="width: 540px; display: inline-block;margin-right: 75px">
                                        ...
                                        <span class="jobcount" v-if="this.resumeDetail.resumeSkillList && this.resumeDetail.resumeSkillList.length>0">{{this.resumeDetail.resumeSkillList.length}}/6</span>
                                ...
                                <el-row style="margin-top: 15px">
                                    <div class="resume-languageinfo">
                                        <div class="resume-edu">
                                            <el-tag
                                                    v-for="skill in this.resumeDetail.resumeSkillList"
                                                    :key="skill.id"
                                                    class="tag-icon"
                                            >{{ skill.name }}
                                            </el-tag>
                                ...
                                <el-row style="margin-bottom: 35px">
                                    <div class="resume-languageinfo">
                                        <div class="resume-introduction">
                                            <span>{{this.resumeDetail.introduction}}</span>
                                        </div>
                                    </div>
                                </el-row>
                            </div>
                ...
                <b-col class="right-box">
                    ...
                    <div class="resume-attachment resume-right-box1">
                        ...
                        <el-row style="display: inline-flex;">
                            <div style="width: 210px">
                                <el-row
                                        v-if="(this.resumeDetail.attachResume && this.resumeDetail.attachResume.length > 0)"
                                ...
                                >
                                    ...
                                    {{this.resumeDetail.name}}个人简历
                                    <!--                                            {{this.resumeDetail.attachResume}}-->
                                </el-row>
                        ...
                        <el-row style="display: inline-flex;">
                            <div style="width: 210px">
                                <div v-if="showEditAttachOther==false">
                                    ...
                                    <el-row
                                            v-for="(others,index) in this.resumeDetail.resumeMergeAttachList"
                                            :key="others.id">
                                        <div style="display: inline-flex">
                                            <div style="display: inline-flex;
                                                                        margin-bottom: 5px;
                    ...
                    <div class="resume-preview resume-right-box1">
                        ...
                        <span class="right-num">{{this.resumeDetail.resumeCompleteProgress}}%</span>
                        <el-progress
                                class="pro-ress"
                                :stroke-width="22"
                                :percentage="this.resumeDetail.resumeCompleteProgress"
                                :status="this.resumeDetail.resumeCompleteProgress == 100? 'success': 'warning'"
                        ></el-progress>
                    </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                resumeEduFormRules: {
                    ...
                    workingDates: [{required: true, message: "请选择在校时间", trigger: "change",},],
                },
                resumeExpForm: {
                    id: undefined,
                    resumeId: undefined,
                ...
                expectJobFormRules:{
                    ...
                    expectWorkType: [{required: true, message: "请选择工作类型", trigger: "blur"}],
                    expectCity:[{required: true, message: "请输入意向城市", trigger: "blur"}],
                },
                uploadPicOptions: {
                    action: "",
                    params: {},
        ...
        methods: {
            ...
            handleAvatarSuccess() {
                ...
                this.resumeDetail.avatar = this.uploadPicOptions.fileUrl;
            ...
            handleUploadAttachmengSuccess() {
                ...
                this.resumeDetail.attachResume = this.uploadAttachmentOptions.fileUrl;
            ...
            handleUploadAttachOthersSuccess(){
                ...
                this.resumeAttachForm1.link=this.uploadAttachmentOptions.fileUrl;
                    if (this.resumeDetail.resumeMergeAttachList && this.resumeDetail.resumeMergeAttachList.length>0){
                        for (i;i<  this.resumeDetail.resumeMergeAttachList.length;i++) {
                            otherAttach=this.resumeDetail.resumeMergeAttachList[i]
            ...
            handleEditAttachOthers(index){
                ...
                console.log(index)
                    this.resumeAttachForm1.name=this.resumeDetail.resumeMergeAttachList[index].name;
                    this.resumeAttachForm1.link=this.resumeDetail.resumeMergeAttachList[index].resumeAttach;
            ...
            handleDelAttachOthers(index){
                ...
                let i=0;
                console.log("3333")
                if (this.resumeDetail.resumeMergeAttachList.length<=1){
            ...
            setResumeFormValues() {
                this.resumeForm.id = this.resumeDetail.id;
                this.resumeForm.name = this.resumeDetail.name;
                this.resumeForm.avatar = this.resumeDetail.avatar;
                this.resumeForm.birth = this.resumeDetail.birth;
                this.resumeForm.gender = this.resumeDetail.gender;
                this.resumeForm.email = this.resumeDetail.email;
                this.resumeForm.returnTime = this.resumeDetail.returnTime;
                this.resumeForm.graduateTime =this.resumeDetail.graduateTime;
                this.resumeForm.curPlace = this.resumeDetail.curPlace;
                this.resumeForm.phone = this.resumeDetail.phone;
                this.resumeForm.priority =this.resumeDetail.priority;
                this.resumeForm.maritalStatus = this.resumeDetail.maritalStatus
                this.resumeForm.introduction =this.resumeDetail.introduction;
            },
            editTitle(){
                this.showEditTitle = true;
                this.resumeTitleForm.title=this.resumeDetail.title
            ...
            saveEditTitle(){
                this.$refs["resumeTitleForm"][0].validate((valid) => {
                    if (valid) {
                        this.posting = true;
                        this.resumeTitleForm.id = this.resumeDetail.id;
            ...
            requiredEdit(){
                if ( this.resumeDetail.name==''||!this.resume[index].name||
                    this.resumeDetail.birth==''||!this.resume[index].birth||
                    this.resumeDetail.gender==''||!this.resume[index].gender||
                    this.resumeDetail.email==''||!this.resume[index].email) {
                    this.handleEditResumeBasic();
                } else if(this.resumeDetail.priority==''||!this.resumeDetail.priority) {
                    this.handleEditPriority();
                }else if(this.resumeDetail.resumeEduList==''||!this.resumeDetail.resumeEduList){
                    this.handleEditResumeEdu()
                }else if (this.resumeDetail.userExpectJob.expectPosition==''||!this.resumeDetail.userExpectJob.expectPosition||
                    this.resumeDetail.userExpectJob.expectCity==''||!this.resumeDetail.userExpectJob.expectCity||
                    this.resumeDetail.userExpectJob.expectWorkType==''||!this.resumeDetail.userExpectJob.expectWorkType){
            ...
            handleEditResumeBasic() {
                ...
                this.resumeForm.curPlace = this.resumeDetail.curPlace;
                this.resumeForm.phone = this.resumeDetail.phone;
                if (this.resumeDetail.maritalStatus==0){
                    this.resumeForm.maritalStatus="中共党员（含预备党员）";
                }else if (this.resumeDetail.maritalStatus==1){
                    this.resumeForm.maritalStatus="民主党派";
                }else if (this.resumeDetail.maritalStatus==2){
                    this.resumeForm.maritalStatus="无党派人士";
                }else if (this.resumeDetail.maritalStatus==3){
                    this.resumeForm.maritalStatus="团员";
                }else if (this.resumeDetail.maritalStatus==4){
            ...
            handleEditResumeIntro() {
                ...
                this.resumeForm1.resumeId=this.resumeDetail.id;
                this.resumeForm1.introduction=this.resumeDetail.introduction;
            ...
            handleSaveResumeAvatar(){
                this.$refs["resumeForm3"][0].validate((valid) => {
                    if (valid) {
                        this.resumeForm3.id = this.resumeDetail.id;
            ...
            handleEditResumeEdu(type, resumeEdu) {
                ...
                this.resumeEduForm.resumeId = this.resumeDetail.id;
                if (type === "update") {
            ...
            handleEditResumeLanguage(type, resumeLanguage) {
                ...
                // console.log(resumeLanguage.description)
                    this.resumeLanguageForm.resumeId = this.resumeDetail.id;
                    if (type === "update") {
            ...
            handleEditResumeAwards(type, resumeAwards) {
                this.showAwardsDialog = true;
                    ...
                    this.resumeAwardsForm.resumeId = this.resumeDetail.id;
                    if (type === "update") {
            ...
            handleEditResumeExp(type, resumeExp) {
                ...
                this.resumeExpForm.resumeId = this.resumeDetail.id;
            ...
            handleEditResumePractice(type, resumePractice) {
                this.showPracticeDialog = true;
                    this.resumePracticeForm.resumeId = this.resumeDetail.id;
                    if (type === "update") {
            ...
            handleEditExpectJob() {
                ...
                if (this.resumeDetail.userExpectJob.salaryId==9){
                    this.salaryCheck==true;
                    this.expectJobForm.salaryId="  "
                }
                this.expectJobForm.resumeId=this.resumeDetail.id;
                this.expectJobForm.expectWorkType=this.resumeDetail.userExpectJob.expectWorkType;
                this.expectJobForm.expectPosition=this.resumeDetail.userExpectJob.expectPosition;

                this.expectJobForm.expectCity=this.resumeDetail.userExpectJob.expectCity
                this.expectJobForm.industry=this.resumeDetail.userExpectJob.industry
                this.$nextTick(() => {
            ...
            handleEditResumeSkill() {
                ...
                if (
                    this.resumeDetail.resumeSkillList &&
                    this.resumeDetail.resumeSkillList.length !== 0
                ) {
                    for (const resumeSkill of this.resumeDetail.resumeSkillList) {
                ...
                console.log(this.resumeDetail.resumeSkillList)
                let result = this.resumeDetail.resumeSkillList.map(((value, index) => {
            ...
            handleSaveResumeAttachResume(){
                this.$refs["resumeForm2"][0].validate((valid) => {
                    if (valid) {
                        this.posting = true;
                            this.resumeForm2.id=this.resumeDetail.id
                            this.resumeForm2.resumeId=this.resumeDetail.id
                ...
                this.$refs["resumeAttachForm"][0].validate((valid) => {
                    if (valid) {
                        ...
                        console.log(this.resumeAttachForm.attachOthers)
                            this.resumeAttachForm.id=this.resumeDetail.id
                            this.resumeAttachForm.resumeId=this.resumeDetail.id
            ...
            handleEditPriority(){
                    this.resumeForm5.resumeId=this.resumeDetail.id;
                    if(this.resumeresumeDetail.priority==0){
                        this.resumeForm5.priority="第一";
                    }else if (this.resumeDetail.priority==1){
                        this.resumeForm5.priority="第二";
                    }
                    else if (this.resumeDetail.priority==2){
                        this.resumeForm5.priority="第三";
                    }
                    else if (this.resumeDetail.priority==3){
                        ...
                        for (const item of this.resume){
                            if(this.resumeForm5.priority==item.priority){
                                this.$confirm('该优先级已存在'+item.title+'中，确认将会把'+item.title+'的优先级后延', '', {
                                    ...
                                    this.resumeForm5.id = this.resumeDetail.id;
            ...
            handleSaveResumeIntro(){
                this.$refs["resumeForm1"][0].validate((valid) => {
                    if (valid) {
                            this.resumeForm1.id = this.resumeDetail.id;
                ...
                this.$refs["resumeForm"].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.resumeForm.maritalStatus=="中共党员（含预备党员）"){
                            ...
                            this.resumeForm.resumeId = this.resumeDetail.id;
            ...
            postSaveResumeBasic() {
                this.resumeForm.id = this.resumeDetail
                saveResumeBasic(this.resumeForm)
                    .then(() => {
                        this.showBasicDialog = false;
                        this.showIntroDialog = false;
            ...
            handleSaveResumeEdu(index) {
                ...
                console.log(this.resumeDetail.updateTime)
            ...
            handlePreview() {
                    this.resumeId = this.resumeDetail.id;
                getResumeDetail(this.resumeId).then((response) =>{
                        this.resumeDetail = response.data;
                        console.log(this.resumeDetail)
                    }
