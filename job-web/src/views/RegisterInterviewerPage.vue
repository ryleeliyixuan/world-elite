            ...
            <el-form ref="formThree" :model="formThree" :rules="rules">
                ...
                <el-form-item label="注意事项：">
                    <div style="line-height: 35px;color: #333333; font-size:18px;margin-left: 48px; margin-top: 50px;">
                        <div> 1、同一个身份证号只能认证一个账号；</div>
                        <div> 2、身份证国徽面与正面信息应为同一身份证的信息且在有效期内；</div>
                        <div> 3、所有上传照片需清晰且未遮挡，请勿进行美化和修改，以免认证失败；</div>
                        <div> 4、 上传本人手持身份证信息面照片中应含有本人头部或上半身；</div>
                        <div> 5、手持身份证照中本人形象需为免冠且并未化妆，五官清晰；</div>
                        <div> 6、拍照手持身份证照时对焦点请置于身份证上，保证身份证信息清晰且未遮挡；</div>
                        <div> 7、上传图片文件格式支持png，jpg和bmp；</div>
                        <div> 8、单张图片大小不超过3MB，尺寸最小为500px * 500px；</div>
                        <div> 9、所有上传信息均会被妥善保管，不会用于其他商业用途或传输给其他第三方；</div>
                    </div>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            onDefaultAvatar(item) {
                this.formOne.avatar = item.avatarUrl;
                this.$refs["formOne"].validateField("avatar");
            },
            addExperience() {
