            ...
            <el-form ref="formOne" :model="formOne" :rules="rules">
                <div style="margin-top: 20px">
                    <el-form-item label="昵称" label-width="100px" prop="nickName">
                        <el-input style="max-width: 200px" v-model="formOne.nickName" placeholder="请输入您的昵称"
                    ...
                    <div>
                        <el-form-item label="所在公司" label-width="100px" prop="companyName">
                            <el-input style="max-width: 200px" v-model="formOne.companyName"
                    ...
                    <div>
                        <el-form-item label="从业经历" label-width="100px" prop="experience">
                            <el-input style="max-width: 200px" type="textarea" v-model="formOne.experience "
                                      placeholder="字数不超过150字" :autosize="{minRows: 3,maxRows: 10}"></el-input>
                        </el-form-item>
                    </div>
                    <div>
                        <el-form-item label="面试官自述" label-width="100px" prop="description">
                            <el-input type="textarea" style="max-width: 200px" v-model="formOne.description"
                                      placeholder="字数不超过150字" :autosize="{minRows: 3,maxRows: 10}"></el-input>
                        </el-form-item>
                    </div>
                </div>
            ...
            <el-form ref="formTwo" :model="formTwo" :rules="rules">
                ...
                <div v-if="checked1===true">
                    <el-form-item label="HR通用面试理想咨询价格：" label-width="300px" style="margin-left: -100px" prop="price">
                        <el-input style="max-width: 300px" v-model="formTwo.price"
                                  placeholder="请输入您理想资询价位 (元/半小时)"></el-input>
                    </el-form-item>
                    <el-form-item label="面试内容简介：" label-width="300px" style="margin-left: -100px" prop="description">
                        <el-input type="textarea" style="width: 200px" v-model="formTwo.description"
                                  placeholder="请对面试的内容进行具体描述，150字以内" :autosize="{minRows: 3,maxRows: 10}"></el-input>
                    </el-form-item>
                </div>
                <div v-if="checked2===true">
                    <el-form-item label="专业技术测试理想咨询价格：" label-width="300px" style="margin-left: -100px" prop="price">
                        <el-input v-model="formTwo.price" style="max-width: 300px"
                                  placeholder="请输入您理想资询价位 (元/半小时)"></el-input>
                    </el-form-item>
                    <el-form-item label="面试内容简介：" label-width="300px" style="margin-left: -100px" prop="description">
                        <el-input type="textarea" style="width: 200px" v-model="formTwo.description"
