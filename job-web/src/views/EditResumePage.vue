<template>
    <div class="app-container">
            ...
            <b-row>
                <b-col cols="8">
                    <div class="resume-body">
                            ...
                            <b-media class="mt-3">
                                <template v-slot:aside>
                                    <el-upload class="avatar-uploader"
                                        ...
                                        <img v-if="(resume.avatar && resume.avatar !== '')"
                                             :src="resume.avatar"
                                             class="avatar"/>
                                ...
                                <h4>
                                    {{resume.name}}
                                    <font-awesome-icon :icon="['fa', 'male']"
                                                       class="text-primary gender-text"
                                                       v-if="resume.gender === 1"/>
                                    <font-awesome-icon :icon="['fa', 'female']"
                        ...
                        <div class="resume-box" id="Resume-Education">
                            <EditResumeTitle title="教育经历"
                                             :icon="['fa', 'plus-square']"
                                             iconText="添加"
                                             v-on:edit-click="handleEditResumeEdu('create')"/>
                            <div class="mt-3">
                                <div class="edit-box pt-2"
                                    ...
                                    <b-media>
                                        <h6>
                                            ...
                                            <span class="ml-3 time-text">{{resumeEdu.startTime}}到{{resumeEdu.finishTime}}</span>
                                        </h6>
                                        <p v-if="resumeEdu.gpa > 0 && resumeEdu.gpa!==''"> {{resumeEdu.degree.name}} / {{resumeEdu.majorName}} / GPA
                                            {{resumeEdu.gpa}}</p>
                                        <p v-else>{{resumeEdu.degree.name}} / {{resumeEdu.majorName}} </p>
                                        <div class="edit-item-box" v-show="resumeEdu.showEditFlag == 1">
                                            <a class="p-2 edit-text" v-on:click="handleEditResumeEdu('update', resumeEdu)">
                        ...
                        <div class="resume-box" id="Resume-Experience">
                            <EditResumeTitle title="工作经验"
                                             :icon="['fa', 'plus-square']"
                                             iconText="添加"
                                             v-on:edit-click="handleEditResumeExp('create')"/>
                            <div class="mt-3">
                                <div class="edit-box pt-2 pb-4"
                                    ...
                                    <b-media>
                                        <h6>
                                            {{resumeExp.company}}
                                            <span class="ml-3 position-text">{{resumeExp.depart}} . {{resumeExp.post}}</span>
                                        ...
                                        <div class="edit-item-box" v-show="resumeExp.showEditFlag == 1">
                                            <a class="p-2 edit-text" v-on:click="handleEditResumeExp('update', resumeExp)">
                                                <font-awesome-icon :icon="['fa', 'pencil-alt']"/>
                                            </a>
                                ...
                                <div class="edit-box pt-2 pb-4"
                                    ...
                                    <b-media>
                                        ...
                                        <div class="edit-item-box" v-show="practice.showEditFlag == 1">
                                            <a class="p-2 edit-text" v-on:click="handleEditResumePractice('update', practice)">
                                                <font-awesome-icon :icon="['fa', 'pencil-alt']"/>
                                            </a>
                        ...
                        <div class="resume-box" id="Resume-Skill">
                            <EditResumeTitle title="能力标签"
                                             :icon="['fa', 'pencil-alt']"
                                             iconText="编辑"
                                             v-on:edit-click="handleEditResumeSkill"/>
                            <div class="mt-3">
                                <el-tag v-for="skill in resume.resumeSkillList"
                                        :key="skill.id"
                                        effect="plain"
                                        class="mr-2">{{ skill.name }}
                                </el-tag>
                            </div>
                        </div>
                        <div class="resume-box" id="Resume-Link">
                            <EditResumeTitle title="社交主页"
                                             :icon="['fa', 'plus-square']"
                                             iconText="添加"
                                             v-on:edit-click="handleEditResumeLink"/>
                            <div class="mt-3">
                                <div class="link-item edit-box"
                ...
                <b-col>
                    <div class="resume-objective resume-right-box">
                        <EditResumeTitle title="求职意向"
                                         :icon="['fa', 'pencil-alt']"
                                         iconText="编辑"
                                         v-on:edit-click="handleEditExpectJob"/>
                        <div class="mt-3" v-if="resume.userExpectJob">
                            <p>
                                <el-tag v-for="city in  resume.userExpectJob.cityList"
                                        :key="city.id"
                                        effect="plain"
                                        class="mr-2"
                                        size="small">
                            ...
                            <p>
                                <el-tag v-for="category in  resume.userExpectJob.categoryList"
                                        :key="category.id"
                                        effect="plain"
                                        class="mr-2"
                                        size="small">
                    ...
                    <div class="resume-attachment resume-right-box">
                        ...
                        <el-upload class="mt-2 upload-attach-box"
                                   :limit="1"
        ...
        <el-dialog title="编辑基本信息" :visible.sync="showBasicDialog" width="600px" top="10vh">
            <el-form ref="resumeForm" :model="resumeForm" :rules="resumeFormRules" label-width="80px">
                ...
                <el-form-item label="生日" prop="birth">
                    <el-date-picker v-model="resumeForm.birth"
                ...
                <el-form-item label="所在城市" prop="curPlace">
                    <el-input v-model="resumeForm.curPlace"
                              class="m-input-text-width"
                              placeholder="比如：洛杉矶"
                              maxlength="50"
                              show-word-limit>
                ...
                <el-form-item label="毕业时间" prop="graduateTime">
                    <el-date-picker v-model="resumeForm.graduateTime"
                                    type="month"
                                    format="yyyy-MM"
                ...
                <el-form-item label="回国时间" prop="returnTime">
                    <el-date-picker v-model="resumeForm.returnTime"
                                    type="month"
                                    placeholder="选择日期"
                                    format="yyyy-MM"
                                    value-format="yyyy-MM">
                ...
                <el-form-item label="联系电话" prop="phone">
                    <el-input placeholder="请输入电话号码"
                              ...
                              maxlength="20"
                              show-word-limit>
                        <el-select v-model="resumeForm.phoneCode"
                                   slot="prepend"
                                   placeholder="电话区号"
                                   clearable
                                   filterable>
                            <el-option :value="country.phoneCode"
        ...
        <el-dialog title="添加教育经历" :visible.sync="showEduDialog" width="500px" top="10vh">
            <el-form ref="resumeEduForm"
                     :model="resumeEduForm"
                     :rules="resumeEduFormRules"
                     label-width="80px">
                <el-form-item label="学校名称" prop="schoolName">
                    <el-autocomplete v-model="resumeEduForm.schoolName"
        ...
        <el-dialog title="添加工作经验" :visible.sync="showExpDialog" width="600px" top="10vh">
            <el-form ref="resumeExpForm"
                     :model="resumeExpForm"
                     :rules="resumeExpFormRules"
                     label-width="80px">
                <el-form-item label="公司名称" prop="company">
                    <el-autocomplete v-model="resumeExpForm.company"
                ...
                <el-form-item label="所属部门" prop="depart">
                    <el-input v-model="resumeExpForm.depart"
                              placeholder="请填写部门信息"
                              :maxlength="40"
                              show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="职位名称" prop="post">
                    <el-input v-model="resumeExpForm.post"
                              placeholder="请填写职位名称"
                              :maxlength="40"
                              show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="在职时间" prop="workingTimeFlag">
                    <el-date-picker v-model="resumeExpForm.workingDates"
                                    type="monthrange"
                                    value-format="yyyy-MM"
                                    start-placeholder="入职时间"
                                    end-placeholder="离职时间"
                                    :disabled="resumeExpForm.onWork == 1"></el-date-picker>
        ...
        <el-dialog title="添加实践经验" :visible.sync="showPracticeDialog" width="600px" top="10vh">
            <el-form ref="resumePracticeForm"
                     :model="resumePracticeForm"
                     :rules="resumePracticeFormRules"
                     label-width="80px">
                <el-form-item label="实践主题" prop="title">
                    <el-input v-model="resumePracticeForm.title"
                              placeholder="请填写实践主题"
                              :maxlength="50"
                              show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="担任职位" prop="post">
                    <el-input v-model="resumePracticeForm.post"
                              placeholder="请填写担任职位"
                              :maxlength="40"
                              show-word-limit></el-input>
                </el-form-item>
                <el-form-item label="实践时间" prop="workingTimeFlag">
                    <el-date-picker v-model="resumePracticeForm.workingDates"
                                    type="monthrange"
                                    value-format="yyyy-MM"
        ...
        <el-dialog title="编辑求职意向" :visible.sync="showExpectJobDialog" width="500px" top="10vh">
            <el-form ref="expectJobForm"
                     :model="expectJobForm"
                     label-width="80px">
                <el-form-item label="意向城市" prop="cityIds">
                    <el-select v-model="expectJobForm.cityIds"
                               multiple
                               filterable
                               clearable
                               placeholder="最多选择三个"
                ...
                <el-form-item label="薪资范围">
                    <el-col :span="11">
                        <el-select v-model="expectJobForm.minSalary"
                                   filterable
                                   clearable
                                   placeholder="请选择"
                                   class="w-100">
                    ...
                    <el-col :span="11">
                        <el-select v-model="expectJobForm.maxSalary"
                                   filterable
                                   clearable
                                   placeholder="请选择"
                                   class="w-100">
