  ...
  <div class="app-container">
    ...
    <div class="title">
      <div class="template-title-container" v-if="type === '1' && templateId">
        ...
        <el-input
          v-if="templateTitleEditing"
          size="small"
          class="value"
          v-model="applyForm.templateName"
          maxlength="20"
          ref="templateTitle"
          @keyup.enter.native="onTemplateTitleEdit"
          @blur="onTemplateTitleCancel"
        ></el-input>
        <span v-else class="template-name">{{ applyForm.templateName }}</span>
        <svg-icon
          :icon-class="templateTitleEditing ? 'edit' : 'edit'"
          clickable
          style="width: 22px; height: 26px; margin-left: 18px"
          @mousedown.stop.prevent="onTemplateTitleEdit"
        ></svg-icon>
      </div>
      <el-input
        v-if="titleEditing"
        ...
        clearable
        ref="title"
        @keyup.enter.native="onTitleEdit"
        @blur="onTitleCancel"
      ></el-input>
      <span v-else class="title-text">{{ applyForm.title }}</span>
      <svg-icon
        :icon-class="titleEditing ? 'edit' : 'edit'"
        clickable
        style="width: 22px; height: 26px; margin-left: 18px"
        @mousedown.stop.prevent="onTitleEdit"
      ></svg-icon>
    </div>
    <div class="form-container">
      ...
      <div :class="['form-item', { hidden: applyForm.genderFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("genderFlag") }}</span
          >性别
        </div>
        <div class="value">
        ...
        <div class="value-item" @click="onHidden('genderFlag')">
          <svg-icon
            :icon-class="getStatusIcon('genderFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('genderFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('genderFlag')"
            clickable
          ></svg-icon>
      ...
      <div :class="['form-item', { hidden: applyForm.phoneFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("phoneFlag") }}</span
          >手机号
        </div>
        <el-input
          size="small"
          class="value"
          :disabled="applyForm.phoneFlag === '2'"
        ></el-input>
        <div class="value-item" @click="onHidden('phoneFlag')">
          <svg-icon
            :icon-class="getStatusIcon('phoneFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('phoneFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('phoneFlag')"
            clickable
          ></svg-icon>
          <span class="optional">此题改为选填</span>
        </div>
      ...
      <div :class="['form-item', { hidden: applyForm.emailFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("emailFlag") }}</span
          >邮箱
        </div>
        <el-input
          size="small"
          class="value"
          :disabled="applyForm.emailFlag === '2'"
        ></el-input>
        <div class="value-item" @click="onHidden('emailFlag')">
          <svg-icon
            :icon-class="getStatusIcon('emailFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('emailFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('emailFlag')"
            clickable
          ></svg-icon>
          <span class="optional">此题改为选填</span>
        </div>
      ...
      <div :class="['form-item', { hidden: applyForm.schoolFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("schoolFlag") }}</span
          >学校
        </div>
        <el-input
          size="small"
          class="value"
          :disabled="applyForm.schoolFlag === '2'"
        ></el-input>
        <div class="value-item" @click="onHidden('schoolFlag')">
          <svg-icon
            :icon-class="getStatusIcon('schoolFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('schoolFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('schoolFlag')"
            clickable
          ></svg-icon>
          <span class="optional">此题改为选填</span>
        </div>
      ...
      <div :class="['form-item', { hidden: applyForm.gradeFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("gradeFlag") }}</span
          >年级
        </div>
        <el-input
          size="small"
          class="value"
          :disabled="applyForm.gradeFlag === '2'"
        ></el-input>
        <div class="value-item" @click="onHidden('gradeFlag')">
          <svg-icon
            :icon-class="getStatusIcon('gradeFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('gradeFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('gradeFlag')"
            clickable
          ></svg-icon>
          <span class="optional">此题改为选填</span>
        </div>
      ...
      <div :class="['form-item', { hidden: applyForm.professionFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("professionFlag") }}</span
          >专业
        </div>
        <el-input
          size="small"
          class="value"
          :disabled="applyForm.professionFlag === '2'"
        ></el-input>
        <div class="value-item" @click="onHidden('professionFlag')">
          <svg-icon
            :icon-class="getStatusIcon('professionFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('professionFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('professionFlag')"
            clickable
          ></svg-icon>
          <span class="optional">此题改为选填</span>
        </div>
      ...
      <div :class="['form-item', { hidden: applyForm.educationFlag === '2' }]">
        <div class="name">
          <span>{{ getMustStatus("educationFlag") }}</span
          >学历
        </div>
        <div class="value">
          <div
        ...
        <div class="value-item" @click="onHidden('educationFlag')">
          <svg-icon
            :icon-class="getStatusIcon('educationFlag')"
            clickable
          ></svg-icon>
        ...
        <div class="value-item" @click="onChangeFlag('educationFlag')">
          <svg-icon
            :icon-class="getSelectedIcon('educationFlag')"
            clickable
          ></svg-icon>
          <span class="optional">此题改为选填</span>
        </div>
      ...
      <el-dropdown
        v-if="applyForm.questionnaireList.length === 0"
        trigger="click"
        placement="bottom-start"
        @command="onQuestionType"
      >
          ...
          <div v-if="question.type === '1'" class="question1-container">
            <div v-if="question.edit" class="question1-edit">
              <div class="question1-edit-line1">
                ...
                <div class="operate-container">
                  <div class="delete" @click="onQuestionDelete(index)">
                    删除此题
                  </div>
                  <el-dropdown
                    trigger="click"
                    placement="bottom-start"
                    @command="onQuestionInsertBefore"
                  >
              ...
              <div class="question1-edit-line4">
                ...
                <div class="type-container">
                  <div
                    ...
                    @click="
                      question.mustAnswer =
                        question.mustAnswer === '0' ? '1' : '0'
                    "
                  >
                    <svg-icon
                      :icon-class="
                        question.mustAnswer === '1'
                          ? 'apply-table-selected'
                          : 'apply-table-unselected'
                      "
                    ></svg-icon>
                    <span class="text">设为必答</span>
                  </div>
                  <el-select
                    v-model="question.typeForSelect"
                    placeholder="更改题型"
                    size="mini"
                    style="margin-left: 26px; width: 160px"
                ...
                <div class="button-container">
                  <div class="cancel" @click="onQuestionDelete(index)">
                    取消
                  </div>
                  <div class="done" @click="onQuestionEditCancel(question)">
                    完成编辑
                  </div>
                </div>
              </div>
            ...
            <div v-else class="question1-done">
              <div class="question1-done-line1">
                <div class="title">
                  <span class="must" v-if="question.mustAnswer === '1'">*</span
                  >{{ question.title }}
                </div>
                <div class="operate-container">
              ...
              <div class="question2-edit-line4">
                ...
                <div class="option-container">
                  ...
                  >
                    ...
                    ></el-input>
                    <svg-icon
                      icon-class="apply-table-delete"
                      clickable
                      @click="onQuestionOptionDelete(question, index)"
                    ></svg-icon>
                  </div>
                  <div
                    class="option-add-button"
                    @click="onQuestionOptionAdd(question)"
                  >
                    <svg-icon
                      icon-class="add"
    ...
    <div class="button-container">
      ...
      <div class="submit" @click="onSubmitApplyTable" v-if="this.type === '0'">
        {{ this.applyForm.id ? "更新报名表" : "保存" }}
      </div>
      <div class="submit" @click="onSaveTemplate" v-if="this.type === '1'">
        {{ templateId ? "更新模板" : "添加模板" }}
      </div>
    </div>
    ...
    >
      <div class="remain">
        剩余可设模板数：{{ templateCount.maxCount - templateCount.count }}
      </div>
      <el-input
        class="editing"
        v-model="applyForm.templateName"
      ...
      ></el-input>
      <div class="button-container">
        <div class="cancel" @click="saveTemplateDialogVisible = false">
          取消
        </div>
    ...
    >
      ...
      <div class="button-container">
        <div class="cancel" @click="updateTemplateDialogVisible = false">
          取消
        </div>
        <div class="confirm" @click="onSaveTemplateConfirm">确定</div>
      </div>
    ...
    <el-dialog
      class="cancel-dialog hide-close-icon"
      title="保存模板成功"
      :center="true"
      :visible.sync="saveTemplateSuccessDialogVisible"
      width="445px"
    >
      <div class="remain" style="text-align: center">
        剩余可设模板数：{{ templateCount.maxCount - templateCount.count }}
      </div>
      <div class="button-container">
        <div
...
export default {
  ...
  methods: {
    initData() {
      ...
      if (this.type === "0") {
        ...
        if (this.applyTableId) {
          this.$axios
            .get(`/activity-questionnaire/${this.applyTableId}`)
            .then((response) => {
        ...
        if (this.templateId) {
          this.$axios
            .get(`/questionnaire-template/${this.templateId}`)
            .then((response) => {
              this.applyForm = response.data;
            });
        }
      ...
      // 加载学历列表
      this.$axios
        .get("/dict/list", { params: { type: 25, limit: 99 } })
        .then((response) => {
    ...
    // 获取单选按钮状态图标
    getValueIcon(key) {
      return this.applyForm[key] === "2"
        ? "apply-table-disabled"
        : "apply-table-unselected";
    },
    ...
    onQuestionInsertBefore(item) {
      this.applyForm.questionnaireList.splice(
        item.index,
        0,
        this.newQuestion(item.type)
      );
    },
    ...
    updateTemplate() {
      return this.$axios.patch(
        `/questionnaire-template/${this.templateId}`,
        this.getFormData()
      );
    },
    ...
    onSubmitApplyTable() {
      if (this.applyTableId) {
        this.$axios
          .patch(
            `/activity-questionnaire/${this.applyTableId}`,
            this.getFormData()
          )
          .then((response) => {
            console.log("更新报名表");
            this.applyTableId = response.data.id;
            this.$storage.setObject("报名表", {
              id: this.applyTableId,
        ...
        this.$axios
          .post("/activity-questionnaire", this.getFormData())
          .then((response) => {
            console.log("添加报名表");
            this.applyTableId = response.data.id;
            this.$storage.setObject("报名表", {
