<template>
  <div class="app-container">
      <div class="mb-2">
          <el-button type="success" @click="onEditRecommendClick" icon="el-icon-plus">推荐职位</el-button>
      </div>
      <el-table
      :key="tableKey"
    ...
    >
      ...
      <el-table-column label="职位ID" prop="object.id"></el-table-column>
      <el-table-column label="职位" align="center" prop="object.name"></el-table-column>
    ...
    >
      <el-form ref="form" :model="recommendForm" label-width="60px" label-position="top">
        <el-form-item label="职位ID">
          <el-input v-model="recommendForm.objectId" placeholder="职位ID" type="number"></el-input>
        </el-form-item>
