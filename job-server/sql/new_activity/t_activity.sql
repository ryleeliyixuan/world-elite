...
CREATE TABLE `t_activity`  (
  ...
  `type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发布账户类型(个人账户/企业账户/管理账户)',
  ...
  `need_resume` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否需要报名者简历信息',
  `only_overseas_student` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否仅留学生能参加',
  `audit_type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报名审核类型(是否需要审核)',
  ...
  `applicant_quantity` int(11) NULL DEFAULT NULL COMMENT '报名人数',
  `weight` int(11) NULL DEFAULT NULL COMMENT '置顶权重',
  `notice` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '通知提示',
